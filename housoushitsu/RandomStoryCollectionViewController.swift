...
//
//class RandomStoryCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
...
//    
//    private let cellVerticalMargin:CGFloat = 0.0
...
//        
//        let flowLayout = StoryCollectionViewFlowLayout()
//        collectionView?.setCollectionViewLayout(flowLayout, animated: true)
//        collectionView?.registerClass(StoryHeaderCollectionReusableView.self, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "Header")
//        
...
//        let headerReusableView = collectionView.dequeueReusableSupplementaryViewOfKind(kind, withReuseIdentifier: "Header", forIndexPath: indexPath) as! StoryHeaderCollectionReusableView
...
//    
//    
//    func collectionView(collectionView: UICollectionView, layout collectionViewLayout: StoryCollectionViewFlowLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
